...
const UploadFile = ({ fileUploadAndPredict }) => {
  return (
    <div className="mt-2 flex w-2/4 justify-center rounded-md border-2 border-dashed border-gray-300 px-6 pt-5 pb-6">
